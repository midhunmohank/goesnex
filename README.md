# Cloud-based API Service for GeoSpatial Data with Authentication, User Plans(API Call Limits), and Dashboards
...
```
## Data Source:
[GOES Satellite Weather Data](https://noaa-goes18.s3.amazonaws.com/index.html#ABI-L1b-RadC/2023/)
